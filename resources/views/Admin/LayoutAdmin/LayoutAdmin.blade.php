...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('public/User')}}/img/attachment_101759249.png" rel="icon">
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('public/Admin')}}/img/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('public/Admin')}}/img/messages-2.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('public/Admin')}}/img/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{asset('public/Admin')}}/img/profile-img.jpg" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed  {{ request()->routeIs('Admin.CategoryIndex') ? 'active' : '' }}" href="{{route("Admin.CategoryIndex")}}">
      ...
      <li class="nav-item">
        <a href="{{route("Admin.ProductIndex")}}" class="nav-link collapsed" >
          <i class="bi bi-box"></i>
          <span>Sản phẩm</span>
        </a>
...
@yield('content')
  ...
  <script src="{{asset('public/Admin')}}/vendor/chart.js/chart.umd.js"></script>
  <script src="{{asset('public/Admin')}}/vendor/echarts/echarts.min.js"></script>
  <script src="{{asset('public/Admin')}}/vendor/quill/quill.js"></script>
