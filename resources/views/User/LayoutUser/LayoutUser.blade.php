...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
          href="{{asset('public/User')}}/img/attachment_101759249.png">
    ...
    <link rel="stylesheet"
          href="{{asset('public/User')}}/owlcarousel/assets/owl.theme.default.min.css" />
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                    ...
                                    <div class="dropdown">
                                        <a class="nav-link dropdown-toggle" style="cursor:pointer;"  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i>Xin chào, @userFullname</a>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('User.Home')}}" ><img src="{{asset('public/User')}}/img/logo.png" alt="Logo"></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                            ...
                            <ul>
                            <li><a ><i class="fa fa-cart-plus"></i> <span id="cartItemCount"></span></a></li>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{asset('public/User')}}/img/banner/bao-tri-dien-may-tat-ca-cac-hang-1.webp" alt="First slide">
                                    </div>
                                    <div class="carousel-item ">
                                        <img class="d-block w-100" src="{{asset('public/User')}}/img/banner/slider_3.webp" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{asset('public/User')}}/img/banner/hinh-mau-banner-dien-may_033706200.jpg" alt="Third slide">
                                    </div>
                                </div>
